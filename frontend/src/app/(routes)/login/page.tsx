    ...
    <div className="min-h-screen bg-mainBg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-[360px]">
        ...
        <div className="card space-y-4">
          <p className="text-md font-semibold text-primary">Iniciar sesión</p>
        ...
        <div className="flex items-center justify-center gap-2 mt-5">
          <span className="badge badge-green text-2xs">DEMO</span>
          <span className="text-xs text-muted">Credenciales pre-cargadas</span>
        </div>
      </div>
    </div>
  );
